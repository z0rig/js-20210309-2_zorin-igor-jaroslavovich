...
export default class ProductForm {
  ...
  fillImagesList(imagesDataArr) {
    ...
    imagesDataArr.forEach(({ source, url }) => {
      imageList.append(this.createImageListItem(url, source));
    });
  }
  ...
  uploadImage() {
    ...
    fileInput.addEventListener('change', async (evt) => {
      ...
      if (img) {
        ...
        imageList.append(this.createImageListItem(result.data.link, img.name));
